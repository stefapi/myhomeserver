...
Heavily inspired from github.com/dbader/schedule
...
class Job:
    ...
    * a quantity of `time units` defined by `interval`
    ...
    def __init__(self, interval: int, scheduler: Optional[Scheduler] = None):
        """
        Create a new job.
        :param interval:  interval in `time units` between runs
        :param scheduler: scheduler that this job will be registered with
        """
